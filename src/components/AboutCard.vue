<template>
    <div class="mt-[100px] md:flex md:flex-col md:justify-center md:items-center lg:justify-start lg:items-start lg:mt-20">
        ...
        <div class="hidden md:block md:py-4">
            ...
            <p class="text-[30px] font-extrabold">
                {{ cognome }}
            </p>
        </div>
         <!-- nome mobile-->
        ...
        <div class=" flex flex-col">
            ...
            <div class="flex items-center mb-2">
                ...
                <a :href="linkedin" class="font-semibold hover:underline hover:underline-offset-4">Linkedin</a>
            </div>

            <!-- github -->
            <div class="flex items-center mb-2">
                <a :href="github" class="mr-1">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" class="w-10 h-10">
                        <path fill="#1b1e22"
                ...
                <a :href="github" class="font-semibold hover:underline hover:underline-offset-4">Github</a>
            </div>
            <!-- mail -->
            <div class="cursor-pointer flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" class="w-10 h-10 mr-1">
                    <path fill="#204a6a"
                ...
                <a href="mailto: {{ nostraEmail }}" class="font-semibold hover:underline hover:underline-offset-4">{{ nostraEmail }}</a>
            </div>
        </div>
    </div>
</template>
...
export default {
    ...
    props: ["nome", "cognome", "linkedin", "github", "nostraEmail","img"]
}
</script>