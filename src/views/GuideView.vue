<template>
    <div class="min-h-screen">
        <div class="pt-[117px] flex justify-center items-center">
            <h1
                class="flex justify-center items-center border-4 border-black border-dotted rounded-lg px-8 py-[4px] text-[20px]">
                <svg class="fill-inherit w-[60px] ml-[-20px] pr-[20px]" version="1.1" id="Capa_1"
        ...
        <div class="flex justify-center items-center mb-[2vw]">
            <p
                ...
                programmazione, inclusi il <span class="font-bold">front-end</span>, il <span
                    class="font-bold">back-end</span>, <span class="font-bold">l'intelligenza artificiale</span> e altro
                ancora. Queste roadmap delineano i percorsi consigliati per acquisire competenze e conoscenze cruciali
                in
                ciascuna area, aiutando gli sviluppatori a pianificare il loro percorso di apprendimento in modo mirato
                e
                progressivo. Indipendentemente dall'ambito di interesse, la nostra documentazione offre un prezioso
                supporto
                per chiunque voglia approfondire le proprie competenze e rimanere aggiornato sulle ultime tecnologie e
                best
